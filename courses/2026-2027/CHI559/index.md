...
<p>第一週將搭建研究環境（GitHub、VS Code、人工智能編程助手）。請攜已安裝妥當的手提電腦上課。</p>
...
<p><strong>3. 個人作業：</strong>兩份作業要求學生將課堂所學數字人文工具與方法，應用於中文語料，以鞏固實作能力。每份作業須繳交書面分析，並附上相關可視化或模型輸出。一律經 Moodle 作業區繳交。</p>
<ul>
<li>作業一：語料比較與搭配分析</li>
<li>作業二：主題模型</li>
</ul>
...
<table class="schedule no-event">
  ...
  <tbody class="due">
    <tr>
      <td></td>
      <td class="date">10月12日</td>
      <td colspan="2"><strong>作業一（語料比較與搭配分析）截止，上午 9:00</strong></td>
    </tr>
  </tbody>
  <tbody class="block-b">
    <tr>
