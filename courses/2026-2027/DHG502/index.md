...
<li>On your laptop, install <a href="https://www.python.org/downloads/">Python</a>, <a href="https://code.visualstudio.com/">Visual Studio Code (VS Code)</a>, and then OpenCode. Step-by-step: <a href="../setup/#option-b">how to set up an AI coding agent</a>. If you cannot install locally, use GitHub Codespaces instead (<a href="../setup/#option-a">same page, Option A</a>): create a new repository from the course template and work in the browser.</li>
...
<p>Week 1 sets up the research environment (GitHub, VS Code, OpenCode, and AI coding assistants). Bring a laptop with the software already installed, or use GitHub Codespaces in the browser if you cannot install locally — see <a href="../setup/#option-a">Option A of the setup page</a>.</p>
