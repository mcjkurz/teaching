...
<p>The course is conducted in English. Assigned readings may be in English or Chinese. Historical sources for assignments and the final project may be in English, Chinese, or other languages relevant to the student’s research. All assessed work must be completed and submitted in English.</p>
...
<li>On your laptop, install <a href="https://www.python.org/downloads/">Python</a>, <a href="https://code.visualstudio.com/Download">Visual Studio Code (VS Code)</a>, and then OpenCode. Step-by-step: <a href="../setup/#opencode">how to set up an AI coding agent</a>. If you cannot install locally, use GitHub Codespaces instead (<a href="../setup/#codespaces">same page</a>): create a new repository from the course template and work in the browser.</li>
...
<p>Week 1 sets up the research environment (GitHub, VS Code, OpenCode, and AI coding assistants). Bring a laptop with the software already installed, or use GitHub Codespaces in the browser if you cannot install locally — see <a href="../setup/#codespaces">the setup page</a>.</p>
...
<p>Requirements and marking criteria are available on the <a href="assignments/">assignments page</a>.</p>
...
<h2>AI Policy</h2>
<p>This course teaches agentic coding, and students are expected to use AI coding assistants for research code. All use must be documented according to the assignment instructions. Students remain responsible for every claim, citation, line of code, and analytical decision they submit, and must be able to explain their work. AI-generated analytical prose may not be submitted as the student’s own work. Do not upload confidential, sensitive, or unpublished sources to an external AI service without permission.</p>
...
<table class="schedule no-event with-notes">
  ...
  <tbody class="due">
    <tr>
      <td></td>
      <td class="date">23 Sep</td>
      <td colspan="3"><a href="assignments/assignment-0/">Assignment 0 (not graded) due, 9:00 am</a></td>
    </tr>
  </tbody>
  <tbody class="block-a">
    <tr>
