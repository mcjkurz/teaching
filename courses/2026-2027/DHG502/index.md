...
<li>On your laptop, install <a href="https://www.python.org/downloads/">Python</a>, <a href="https://code.visualstudio.com/Download">Visual Studio Code (VS Code)</a>, and then OpenCode. Step-by-step: <a href="../setup/">how to set up an AI coding agent</a>. If you cannot install locally, use GitHub Codespaces instead (<a href="../setup/">same page</a>): create a new repository from the course template and work in the browser.</li>
...
<p>Week 1 sets up the research environment (GitHub, VS Code, OpenCode, and AI coding assistants). Bring a laptop with the software already installed, or use GitHub Codespaces in the browser if you cannot install locally — see <a href="../setup/">the setup page</a>.</p>
