...
<ul>
<li><strong>(a) Local:</strong> install <a href="https://www.python.org/downloads/">Python</a>, <a href="https://code.visualstudio.com/Download">VS Code</a>, <a href="../../../setup/">OpenCode</a>, and <a href="https://www.google.com/chrome/">Chrome</a> or <a href="https://www.microsoft.com/edge">Edge</a>. Clone the <code>dhg502</code> repo and open it in VS Code (<strong>File → Open Folder</strong>).</li>
...
<p>For OpenCode, follow the local install steps on the setup page: <a href="../../../setup/">how to set up an AI coding agent</a>.</p>
