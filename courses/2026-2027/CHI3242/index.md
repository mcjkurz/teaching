...
<li>A classroom with computers will be available. You may also bring your own laptop. If you use your own computer, install <a href="https://www.python.org/downloads/">Python</a>, <a href="https://code.visualstudio.com/">Visual Studio Code (VS Code)</a>, and then OpenCode before the first class. Step-by-step: <a href="../setup/#option-b">how to set up an AI coding agent</a>. If you cannot install locally, use GitHub Codespaces instead (<a href="../setup/#option-a">same page, Option A</a>).</li>
</ol>
...
<li>課堂備有電腦室。亦可自備手提電腦。若使用個人電腦，請於開課前安裝 <a href="https://www.python.org/downloads/">Python</a>、<a href="https://code.visualstudio.com/">Visual Studio Code（VS Code）</a>，然後安裝 OpenCode。步驟見<a href="../setup/#option-b-zh">如何安裝人工智能編程助手</a>。若無法本機安裝，可改用 GitHub Codespaces（<a href="../setup/#option-a-zh">同一頁方案 A</a>）。</li>
</ol>
