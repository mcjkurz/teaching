...
<li>課堂備有電腦室。亦可自備手提電腦。若使用個人電腦，請於開課前安裝 <a href="https://www.python.org/downloads/">Python</a>、<a href="https://code.visualstudio.com/">Visual Studio Code（VS Code）</a>，然後安裝 OpenCode。步驟見<a href="notes/setup/">如何安裝 OpenCode</a>。若無法本機安裝，可改用 GitHub Codespaces（同一頁第 5 節）。</li>
</ol>
